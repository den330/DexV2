...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.jackY.Dex")!.appending(path: "Dex.sqlite")
        }
